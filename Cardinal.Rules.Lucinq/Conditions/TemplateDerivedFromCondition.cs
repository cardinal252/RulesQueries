...
namespace Cardinal.Rules.Lucinq.Conditions
{
    ...
    /// </typeparam>
    public class TemplateDerivedFromCondition<T> : AbstractQueryCondition<T, ISitecoreQueryBuilder>, ILuceneQueryConditionVisitor
        where T : RuleContext
    {
        /// <summary>
        ...
        public override void VisitQuery<TContext>(ISitecoreQueryBuilder queryBuilder, TContext ruleContext)
        {
            ...
            queryBuilder.TemplateDescendsFrom(id, Matches);
        }
    }
}